...
new TypeIt("#type1", {
  ...
  .type("Technicien", { delay: 400 })
  .pause(500)
  .delete(10)
  .type("informatique", { delay: 400 })
  .pause(500)
  .delete(12)
  .go();
...
new TypeIt("#type2", {
  ...
  .type("un Technicien", { delay: 400 })
  .pause(500)
  .delete(13)
  .type("en informatique", { delay: 400 })
  .pause(500)
  .delete(15)
  .go();
...
// javascript pour les slides d'images
